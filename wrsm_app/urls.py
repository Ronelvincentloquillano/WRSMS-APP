...
urlpatterns = [
    path('offline/', views_offline.offline_page, name='offline'),
    path('manifest.json', views_offline.pwa_manifest, name='pwa_manifest'),
    path('serviceworker.js', views_offline.pwa_serviceworker, name='pwa_serviceworker'),
    ...
    path('subscription/manual-payment/', views_subscription.submit_manual_payment, name='submit-manual-payment'),
    path('subscription/payment-requests/', views_subscription.subscription_payment_requests, name='subscription-payment-requests'),
    path('subscription/payment-requests/<int:pk>/approve/', views_subscription.approve_subscription_payment, name='approve-subscription-payment'),
    path('subscription/payment-requests/<int:pk>/reject/', views_subscription.reject_subscription_payment, name='reject-subscription-payment'),
    ...
    path('sales-and-orders/', views.SalesAndOrdersView.as_view(), name='sales-and-orders'),
    ...
    path('price-history/', views.ProductPriceHistoryListView.as_view(), name='price-history'),
    path(
        'price-history/product/<int:product_pk>/',
        views.ProductPriceHistoryListView.as_view(),
    ...
    path('update-container-record/<int:pk>/', views.update_container_record, name='update-container-record'),
    path('delete-container-record/<int:pk>/', views.delete_container_record, name='delete-container-record'),
    ...
    path('admin-settings/', views.AdminSettingsPortalView.as_view(), name='admin-settings-portal'),
